          ...
          <div className="grid place-content-center w-[200px] h-[200px] rounded-full bg-[#F0F0F0] absolute right-[96px] hover:right-[4px] duration-500 cursor-pointer">
            ...
            <div className="p-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="41" height="32" viewBox="0 0 41 32" fill="none">
                <path d="M0 16H40M40 16L39.2623 15.953C30.8452 15.4172 24.2926 8.43412 24.2926 0V0M40 16L39.2623 16.047C30.8452 16.5828 24.2926 23.5659 24.2926 32V32" stroke="#1A1A1A" strokeWidth="3" />
              </svg>
            </div>
          </div>
